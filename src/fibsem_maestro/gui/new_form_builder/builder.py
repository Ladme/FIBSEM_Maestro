...
from fibsem_maestro.gui.new_form_builder._write_back import WriteBack
...
from fibsem_maestro.gui.new_form_builder.widgets.action_select import ActionSelectWidget
from fibsem_maestro.gui.new_form_builder.widgets.area_select.widget import (
    AreaSelectWidget,
)
from fibsem_maestro.gui.new_form_builder.widgets.base import BaseWidget, OnChange, _noop
from fibsem_maestro.gui.new_form_builder.widgets.bool import BoolWidget
from fibsem_maestro.gui.new_form_builder.widgets.detail_band import DetailBandWidget
from fibsem_maestro.gui.new_form_builder.widgets.enum import EnumWidget
from fibsem_maestro.gui.new_form_builder.widgets.float import FloatWidget
from fibsem_maestro.gui.new_form_builder.widgets.float_tuple import FloatTupleWidget
from fibsem_maestro.gui.new_form_builder.widgets.group_wrapper import GroupWrapper
from fibsem_maestro.gui.new_form_builder.widgets.int import IntWidget
from fibsem_maestro.gui.new_form_builder.widgets.list import ListWidget
from fibsem_maestro.gui.new_form_builder.widgets.multi_select import MultiSelectWidget
from fibsem_maestro.gui.new_form_builder.widgets.object import ObjectWidget
from fibsem_maestro.gui.new_form_builder.widgets.optional import OptionalWidget
from fibsem_maestro.gui.new_form_builder.widgets.range_pair import RangePairWidget
from fibsem_maestro.gui.new_form_builder.widgets.string import StringWidget
from fibsem_maestro.gui.new_form_builder.widgets.text_area import TextAreaWidget
...
class FormBuilder:
    ...
    def build_form(
        ...
        self._microscope = workflow_manager.workflow.microscope
        self._manufacturer_properties = self._microscope.control.manufacturer_prop_names
        self._action = action

        infos = get_field_infos(type(settings))
        if fields is not None:
            infos = [fi for fi in infos if fi.name in fields]

        return self._build_object(type(settings), settings, infos)
