...
class MemoryPropsStore(PropsStore):
    """
    PropsStore that holds all data in a dictionary rather than writing to disk.
    ...
    def __init__(
        ...
        ctx: SliceContext,
        *,
        _store: dict[tuple[int | None, str], GlobalProperties] | None = None,
        _slice_provider: Callable[[], int | None] | None = None,
    ) -> None:
        self._ctx = ctx
        self._store: dict[tuple[int | None, str], GlobalProperties] = (
